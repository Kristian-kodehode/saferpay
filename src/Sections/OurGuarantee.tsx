      ...
      <div className="section-div">
        ...
        <div className="cards-container">
          ...
          <div className="guarantee-card">
            ...
            <h6>guarantee</h6>
            <h3>Saferpay is your only key, and we are never lost.</h3>
          </div>
        </div>
      </div>

      <div className="section-div">
        <h2 className="section-heading">Seriously good</h2>
        <div className="cards-container">
          <div className="seriously-good-card">
            ...
            />
            <h4>Our employees are the best at what they do</h4>
          </div>
          <div className="seriously-good-card">
            <img
            ...
            />
            <h4>We collaborate across the board to give you the best.</h4>
          </div>
          <div className="seriously-good-card">
            <img
              ...
              alt="arms holding eachother to form a square fence"
            />
            <h4>We mean business when it is about our customers</h4>
          </div>
        </div>
      </div>
    </section>
